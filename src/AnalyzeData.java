...
public class AnalyzeData {
	...
	public AnalyzeData(){
		...
		try {
			...
			textInput = new Scanner(new FileInputStream("TestBank.txt"));
	...
	public void readQuestionFirst(String[] data) {
	    ...
	    this.settingScoreFromFirstPart(array, ans, data);
	}
	
	private void settingScoreFromFirstPart(int[] checkTable, int[] personalAnswerToFirstPart, String[] data) {
		...
		this.readQuestionSecond(data);
	}
	private void readQuestionSecond(String[] data) {	
		...
		try {
			...
			textInput = new Scanner(new FileInputStream("MainChoice.txt"));
		}catch(FileNotFoundException e) {
		...
		this.calculatingScore(data);
	}
	
	private void leftFromMain() {
		...
		try {
			...
			textInput = new Scanner(new FileInputStream("Choice1.txt"));
		}catch(FileNotFoundException e) {
	...
	private void middleFromMain() {
		...
		try {
			...
			textInput = new Scanner(new FileInputStream("Choice2.txt"));
		}catch(FileNotFoundException e) {
	...
	private void rightFromMain() {
		...
		try {
			...
			textInput = new Scanner(new FileInputStream("Choice3.txt"));
		}catch(FileNotFoundException e) {
