...
import java.util.Scanner ;
	...
	public class InputNeed {
		...
		public InputNeed(){
			...
			System.out.print("請輸入星座(Ex:水瓶座、射手座、雙子座、獅子座、金牛座、天秤座、牡羊座、巨蟹座、處女座、摩羯座、雙魚座、天蠍座): ") ;
			...
			System.out.print("請輸入性向(異性戀or同性戀): ") ;
			...
			System.out.print("請輸入血型(A,B,AB,O): ") ;
